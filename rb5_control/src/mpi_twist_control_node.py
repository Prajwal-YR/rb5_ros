...
class MegaPiControllerNode:
    ...
    def twist_callback(self, twist_cmd):
        ...
        jacobian_matrix = np.array(
            [[1, -1, -(self.lx + self.ly)], [1, 1, (self.lx + self.ly)],
             [1, 1, -(self.lx + self.ly)], [1, -1,
        ...
        self.mpi_ctrl.setFourMotors(result[0][0], result[1][0], result[2][0],
                                    result[3][0])
...
if __name__ == "__main__":
    ...
    rospy.Subscriber('/twist',
                     Twist,
                     mpi_ctrl_node.twist_callback,
                     queue_size=1)
